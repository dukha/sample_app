...
class User < ActiveRecord::Base
  ...
  # class method to authenticate the user by email/password
  ...
  private
    ...
    def encrypt_password
       # below is the same as self.encrypted_password = encrypt(self.password)
       # self is only required in the assignment
